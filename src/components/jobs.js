      ...
      >
        <div class="container xl:max-w-6xl mx-auto px-4">
          ...
          <div class="flex flex-wrap flex-row -mx-4 text-center">
            ...
            >
              <div class="py-8 px-12 mb-12 bg-white drop-shadow-[0_35px_35px_#e2e7f7] rounded-2xl transform transition duration-300 ease-in-out hover:-translate-y-2 h-72 w-64">
                ...
                <h3 class="text-lg leading-normal mb-2 font-semibold text-[#112d58]">
                  Accounting / Finance
                </h3>
                <p class="text-gray-500">100 open position</p>
              </div>
            </div>
            <div
              class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp"
            ...
            >
              <div class="py-8 px-12 mb-1 transform transition duration-300 ease-in-out hover:-translate-y-2 h-72 w-64 rounded-2xl bg-white drop-shadow-[0_35px_35px_#e2e7f7] ">
                <div class="inline-block text-gray-900 mb-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="2rem"
